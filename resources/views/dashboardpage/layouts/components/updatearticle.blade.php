            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/updatedata/{{ $data->id_article }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="" class="form-label">Judul </label>
                        <input type="text" name="judul" value="{{ $data->judul }}" class="form-control" id="" value=""placeholder="Masukkan Judul" >
                      </div>
                      <div class="form-group">
                      <div class="mb-3">
                        <label for="">Ringkasan</label>
                        <textarea class="form-control" name="ringkasan" placeholder="Ringkasan"  rows="4" required>{{ $data->ringkasan }}</textarea>
                      </div>
                      <div>
                        <label for="">Deskripsi</label>
                        <textarea name="isi_article" id="informasi">{{ $data->isi_article }}</textarea>
                      </div>
                      </div>

                      <div class="mb-3">
                      <button type="submit" class="btn btn-primary">Kirim</button>
                    <button class="btn btn-light"><a style="color:black; text-decoration:none;" href="/deskripsi">Batal</a></button>
                  </form>
                </div>
              </div>
            </div>
