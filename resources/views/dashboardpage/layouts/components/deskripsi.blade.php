                ...
                <tbody>
                  ...
                  @foreach ($deskripsi  as $item)
                      <tr>
                        ...
                        <td value="{{ $item->id_user }}">{{ $item ->name }}</td>
                        <td>
                          <button class="btn btn-success"><a href="/updatedeskripsi/{{ $item->id_deskripsi }}"><i class="fa-solid fa-pen-to-square" style="color: #f4f5f6;"></i></a></button>
                        </td>
                      </tr>
                  @endforeach
                </tbody>
