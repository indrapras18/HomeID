                ...
                <div class="card-body">
                  ...
                  <form action="/updateuser/{{ $data->id }}" method="post">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" value="{{ $data->username }}" name="username" class="form-control" id="" value=""placeholder="masukkan username">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Email </label>
                        <input type="text" value="{{ $data->email }}" name="email" class="form-control" id="" value=""placeholder="masukkan username">
                      </div>
                      <div class="mb-3">
                        <label for="message-text" class="col-form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="message-text" placeholder="Enter Komentar">{{ $data->alamat }}</textarea>
                      </div>
                    </div>
