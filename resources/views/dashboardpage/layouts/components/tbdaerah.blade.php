  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="addDaerah">
          @csrf
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Nama Daerah</label>
            <input type="text" name="nama_daerah" class="form-control" id="recipient-name" placeholder="Enter Nama Daerah">
          </div>
          {{-- <div class="mb-3">
            <label for="message-text" class="col-form-label">Deskripsi</label>
            <textarea class="form-control" id="message-text" placeholder="Enter Deskripsi"></textarea>
          </div> --}}
...
{{-- akhir modal --}}
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tabel Daerah</h4>
                      ...
                      <tbody>
                        @foreach ($item as $item)
                            <tr>
                              ...
                              <td>
                                <button><a href="/updatedaerah/{{ $item->id_daerah }}">Ubah</a></button>
                                <button><a href="/deletedaerah/{{ $item->id_daerah }}">Hapus</a></button>
                              </td>
                            </tr>
                        @endforeach
