      ...
      <div class="modal-body">
        <form method="POST" action="tambahdata">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="alamat" class="form-control" id="recipient-name" placeholder="Enter Alamat">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Daya Listrik</label>
            <input type="text" name="daya_listrik" class="form-control" id="recipient-name" placeholder="Enter Daya Listrik">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Jumlah Kamar</label>
            <input type="number" name="jumlah_kamar" class="form-control" id="recipient-name" placeholder="Enter Jumlah Kamar">
          </div><div class="mb-3">
            <label for="recipient-name" class="col-form-label">Luas Kamar</label>
            <input type="number" name="luas_kamar" class="form-control" id="recipient-name" placeholder="Enter Luas Kamar">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Luas Dapur</label>
            <input type="number" name="luas_dapur" class="form-control" id="recipient-name" placeholder="Enter Luas Dapur">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Luas Kamar Mandi</label>
            <input type="number" name="luas_kamar_mandi" class="form-control" id="recipient-name" placeholder="Enter Luas Kamar Mandi">
          </div>
  ...
  <div class="card">
    <div class="card-body">
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Tambah Data </button>
                      ...
                      <tbody>
                        ...
                        @foreach ($item as $item)
                            <tr>
                              ...
                              <td>{{$item -> luas_kamar_mandi}}</td>
                              <td>
                                <button><a href="/updatedetail/{{ $item->id_detail }}">Ubah</a></button>
                                <button><a href="/hapus/{{ $item->id_detail }}">hapus</a></button>
                              </td>
                            </tr>
                        @endforeach
                      </tbody>
        ...
        <!-- partial:frontend_dashboard/partials/_footer.html -->
        <footer class="footer">
