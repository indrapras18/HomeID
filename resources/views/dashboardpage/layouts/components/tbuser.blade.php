      ...
      <div class="modal-body">
        <form method="POST" action="/adduser">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" name="alamat" id="message-text" placeholder="Enter Komentar"></textarea>
          </div>
          <label for="recipient-name" class="col-form-label">Jenis Kelamin</label>
          <select name="gender" class="custom-select">
            <option selected>Open this select menu</option>
            <option value="Laki-Laki">Laki-Laki</option>
            <option value="Perempuan">Perrempuan</option>
          </select>
      </div>
                ...
                <tbody>
                  ...
                  @foreach ($users as $item)
                      <tr>
                        ...
                        <td>{{ $item->gender }}</td>
                        <td>
                          <button class="btn btn-success"><a href="/tampilupdateuser/{{ $item->id }}"><i class="fa-solid fa-pen-to-square" style="color: #f4f5f6;"></i></a></button>
                          <button class="btn btn-danger"><a href="/delete/{{ $item->id }}"><i class="fa-solid fa-trash" style="color: #f3f4f7;"></i></a></button>
                        </td>
                      </tr>
                  @endforeach
                </tbody>
