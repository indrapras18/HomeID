    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{!! asset('tbuser') !!}">
              <i class="icon-head menu-icon"></i>
              <span class="menu-title">User</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{!! asset('tbrumah') !!}">
              <i class="icon-bar-graph menu-icon"></i>
              <span class="menu-title">Rumah</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{!! asset('tbkomentar') !!}">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title">About Home</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{!! asset('/tbarticle') !!}">Article</a></li>
                <li class="nav-item"> <a class="nav-link" href="{!! asset('/deskripsi') !!}">Deskripsi Website</a></li>
              </ul>
            </div>
          </li>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Update Rumah</h4>
                  <form action="/updaterumah/{{ $data->id_rumah }}" method="post">
                      @csrf
                      <div class="mb-3">
                          <label for="" class="form-label">Tipe Rumah </label>
                          <input type="text" name="tipe_rumah" class="form-control" id="" value="{{ $data->tipe_rumah }}" placeholder="Masukkan Tipe" >
                        </div>
                        <div class="mb-3">
                          <label for="" class="form-label">Tipe Rumah </label>
                          <input type="text" name="judul" class="form-control" id="" value="{{ $data->judul }}" placeholder="Masukkan Judul" >
                        </div>
                      <div class="mb-3">
                        <label for="" class="form-label">Harga Rumah </label>
                        <input type="number" name="harga_rumah" class="form-control" id="" value="{{ $data->harga_rumah }}" placeholder="Masukkan Harga">
                      </div>
                        <div class="form-group">
                      <div class="mb-3">
                          <label for="" class="form-label">Luas Bangunan </label>
                          <input type="text" name="luas_bangunan" class="form-control" id="" value="{{ $data->luas_bangunan }}" placeholder="masukkan  harga">
                        </div>
                        <div class="mb-3">
                          <label for="" class="form-label">Luas Tanah </label>
                          <input type="text" name="luas_tanah" class="form-control" id="" value="{{ $data->luas_tanah }}" placeholder="masukkan  harga">
                        </div>
                        <div class="mb-3">
                          <label for="" class="form-label">Total Kamar Mandi </label>
                          <input type="number" name="total_kamar_mandi" class="form-control" id="" value="{{ $data->total_kamar_mandi }}" placeholder="masukkan  harga">
                        </div>
                        <div class="mb-3">
                          <label for="" class="form-label">Total Kamar </label>
                          <input type="number" name="total_kamar" class="form-control" id="" value="{{ $data->total_kamar }}" placeholder="masukkan  harga">
                        </div>
                        <div class="mb-3">
                          <label for="" class="form-label">Garasi</label>
                          <input type="" name="total_garasi" class="form-control" id="" value="{{ $data->total_garasi }}" placeholder="masukkan  harga">
                        </div>
                        <div class="mb-3">
                          <label for="">Alamat</label>
                          <textarea class="form-control" name="alamat_rumah" placeholder="masukkan alamat"  rows="4" required>{{ $data->alamat_rumah }}</textarea>
                        </div>
                        <label for="recipient-name" class="col-form-label">Nama Penjual</label>
                        ...
                        <div>
                          ...
                          <textarea name="deskripsi" id="informasi">{{ $data->deskripsi }}</textarea>
                        </div>
                        </div>
