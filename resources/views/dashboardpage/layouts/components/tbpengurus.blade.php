  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="frontend_dashboard/index.html"><img src="frontend_dashboard/images/logo.svg" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="frontend_dashboard/index.html"><img src="frontend_dashboard/images/logo-mini.svg" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="frontend_dashboard/images/faces/face28.jpg" alt="profile"/>
            </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Nama Pengurus</label>
            <input type="text" class="form-control" id="recipient-name" placeholder="Enter Nama Pengurus">
          </div>
        </div>
