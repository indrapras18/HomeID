      ...
      <div class="modal-body">
        <form>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="message-text" placeholder="Enter Komentar"></textarea>
          </div>
        </form>
      </div>
              ...
              <table id="data" class="table ">
                ...
                @foreach ($item as $item)
                  <tr>
                    ...
                    <td>{{ $item -> komentar }}</td>
                    <td>
                      <button class="btn btn-success"><a href="/tampildata/{{ $item->id }}"><i class="fa-solid fa-pen-to-square" style="color: #f4f5f6;"></i></a></button>
                      <button class="btn btn-danger"><a href="/deletekomentar/{{ $item->id }}"><i class="fa-solid fa-trash" style="color: #f3f4f7;"></i></a></button>
                    </td>
                  </tr>
              @endforeach
                </tbody>
