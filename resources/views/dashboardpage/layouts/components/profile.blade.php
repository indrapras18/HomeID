                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('name', Auth::user()->name) }}" name="name" class="form-control" id="fullName" placeholder="Enter full name">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="eMail">Email</label>
                                        <input type="email" value="{{ old('email', Auth::user()->email) }}" name="email" class="form-control" id="eMail" placeholder="Enter email">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="phone">Phone</label>
                                        <input type="text" value="{{ old('phone', Auth::user()->phone) }}" name="phone" class="form-control" id="phone" placeholder="Enter phone number">
                                    </div>
                                </div>
                            </div>
                            <div class="row gutters">
                            ...
                            <div class="row gutters">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="text-right">
                                        <button type="submit" id="submit" name="submit" class="btn btn-primary">Ubah Akun</button>
                                    </div>
                                </div>
                            </div>
                      </form>
                      <div class="delete">
                        <form action="{{ route('deleteprofile') }}" method="post" cl>
                          @csrf
                          @method('delete')
                          <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-right">
                                    <button style="margin-top:10px;" type="submit" id="submit" name="submit" class="btn btn-danger">Hapus Akun</button>
                                </div>
                            </div>
                        </div>
                        </form>
