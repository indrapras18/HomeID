...
<div class="col-lg-16 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Tabel Article</h4>
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><a style="color: white; text-decoration:none;" href="/article">Tambah Data</a></button>
                ...
                <tbody>
                  @foreach ($rows as $item)
                      <tr>
                        <td>{{ $no++ }}</td>
                        <td>{{ $item->judul }}</td>
                        <td><img src="{{ asset('foto article/'.$item->foto_article) }}" alt=""></td>
                        <td>{{ $item->ringkasan }}</td>
                        <td>{!! $item->isi_article !!}</td>
                        <td>
                          <button class="btn btn-success"><a href="/updatearticle/{{ $item->id_article }}"><i class="fa-solid fa-pen-to-square" style="color: #f4f5f6;"></i></a></button>
                          <button class="btn btn-danger"><a href="/deleteaerticle/{{ $item->id_article }}"><i class="fa-solid fa-trash" style="color: #f3f4f7;"></i></a></button>
                        </td>
                      </tr>
                  @endforeach
                </tbody>
