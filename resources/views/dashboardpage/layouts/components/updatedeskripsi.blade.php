        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Update Deskripsi</h4>
                  <form action="/update/{{ $data->id_deskripsi }}" method="POST" enctype="multipart/form-data">
                    @csrf
                      <div class="mb-3">
                        <label for="">Deskripsi</label>
                        <textarea class="form-control" name="deskripsi" placeholder="masukkan deskripsi"  rows="4" required>{{ $data->deskripsi }}</textarea>
                      </div>
                      <div class="mb-3">
                      <label for="exampleFormControlFile1">Penulis</label>
