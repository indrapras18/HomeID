  ...
  <div class="container-scroller">
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="/index"><img src="{!! asset('frontend_dashboard/images/home.png') !!}"style="width:150px;height:40px;" class="mr-2" alt="logo"/></a>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Update Komentar</h4>
                  <form action="/updatekomentar/{{ $data->id }}" method="post">

                    @csrf
                    <div class="mb-3">
                      <label for="" class="form-label">Nama </label>
                      <input type="text" name="nama" class="form-control" id="" value="{{ $data->nama }}"placeholder="masukkan nama"autofocus required
                       oninvalid="this.setCustomValidity('Nama Wajib Diisi')" oninput="this.setCustomValidity('')">
                    </div>
                      <div class="mb-3">
                        <label for="" class="form-label">Email</label>
                        <input type="email" class="form-control" name="email" id="" value="{{ $data->email }}"placeholder="masukkan email" required
                        oninvalid="this.setCustomValidity('Email Harus Diisi dengan menggunakan karakter ...@gmail.com')" oninput="this.setCustomValidity('')">
                      </div>
                      <div class="mb-3">
                        <label for="">Komentar</label>
                        <textarea class="form-control" name="komentar" placeholder="masukkan komentar"  rows="4" required 
                        oninvalid="this.setCustomValidity('Komentar Harus Diisi')" oninput="this.setCustomValidity('')">{{ $data->komentar }}</textarea>
                      </div>
...
<style>
  ...
  input:required:invalid{
    border: none;
    outline: 2px solid rgb(187, 11, 11);
    border-radius: 2px;
  }
  input:valid,
  input:required{
