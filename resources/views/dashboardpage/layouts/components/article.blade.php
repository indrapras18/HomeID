                  ...
                  <form action="/createarticle" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="input-group mb-3">
                        <input type="file" name="foto_article">
                        @error('foto_article')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
                      <div class="mb-3">
                        ...
                        <textarea class="form-control @error('ringkasan') is-invalid @enderror" name="ringkasan" placeholder="Ringkasan" value=""></textarea>
                        @error('ringkasan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                      ...
                      {{-- <div class="mb-3">
                        <label for="">Ringkasan</label>
                        <textarea class="form-control" name="ringkasan" placeholder="Ringkasan" @error('ringkasan')    
                        @enderror></textarea>
                        @error('ringkasan')
                    ...
                    @enderror
                      ...
                      <div>
                        ...
                        <textarea name="isi_article" id="informasi"></textarea>
                      </div>
                      </div>
